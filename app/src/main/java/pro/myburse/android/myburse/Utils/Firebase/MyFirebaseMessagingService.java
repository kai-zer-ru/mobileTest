...
import pro.myburse.android.myburse.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            Log.wtf(TAG, "Data Payload: " + remoteMessage.getData().toString());
    ...
    private void handleDataMessage(JSONObject json) {
        Log.wtf(TAG, "push json: " + json.toString());
        ...
        try {
            ...
            Log.wtf(TAG, "isBackground: " + isBackground);
            Log.wtf(TAG, "payload: " + payload.toString());
            Log.wtf(TAG, "imageUrl: " + imageUrl);
            Log.wtf(TAG, "timestamp: " + timestamp);
